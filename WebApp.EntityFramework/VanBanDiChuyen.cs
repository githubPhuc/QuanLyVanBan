...
namespace ToolsApp.EntityFramework
{
    ...
    public partial class VanBanDiChuyen
    {
        public int Id { get; set; }
        public Nullable<int> IdDiaDiemNhan { get; set; }
        public Nullable<int> IdDiaDiemGui { get; set; }
        public Nullable<int> NguoiKy { get; set; }
        public Nullable<System.DateTime> NgayKy { get; set; }
        public Nullable<bool> IsTrangThaiDenDi { get; set; }
